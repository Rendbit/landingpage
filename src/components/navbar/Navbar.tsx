...
export default function Navbar() {
  return (
    <div className="text-white w-[1300px] mx-auto flex items-center justify-between mt-[35px]">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="relative rounded-[13px] p-0.5 bg-gradient-to-r from-cyan-300 to-blue-400 shadow-lg">
            ...
            {/* Actual button */}
            <button
              className="relative text-white font-bold bg-[#0E7BB2] py-3 px-6 rounded-[13px] transition-all duration-300"
            >
