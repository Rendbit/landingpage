            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-sm md:text-base">
              ...
              >
                ...
                <p className="text-left">
                  Enjoy seamless transactions without the need for a foreign
                  account. Manage your funds effortlessly on both desktop and
                  mobile platforms.
                </p>
              </motion.div>
              ...
              >
                ...
                <hr className="w-full border-gray-500" />
                <p className="text-left">
                  Transact within Africa effortlessly with Rendbit, enabling
                  seamless payments and currency swaps.
                </p>
              </motion.div>
              ...
              >
                ...
                <hr className="w-full border-gray-500" />
                <p className="text-left">
                  Experience lightning-fast transactions with Rendbit, ensuring
                  your cross-border payments are completed efficiently and
                  without delays.
                </p>
              </motion.div>
            </div>
